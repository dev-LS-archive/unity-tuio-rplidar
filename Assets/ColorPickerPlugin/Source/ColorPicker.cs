...
public class ColorPicker : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IDragHandler, IEndDragHandler
{
    ...
    private void OnPickingColor()
    {
        ...
        var rect = targetPaletteImage.rectTransform.rect;
        mPos *= new Vector2(paletteImgSrc.width / rect.width, paletteImgSrc.height / rect.height);
        ...
        {
            ColorPickerResult = new Color(ColorPickerResult.r, ColorPickerResult.g, ColorPickerResult.b,
                PlayerPrefs.GetFloat("Alpha"));
        }
